// The default router for the Endorser Service UI backend
// Expand on this (or add other router files) if the Endorser Service UI backend should do much more business actions
// other than serving the static files and proxying to Endorser Service

import express, { Response } from "express";
import config from "config";
import * as innkeeperComponent from "../components/endorser";
